...
public abstract class CameraGLRenderer implements GLSurfaceView.Renderer,
    ...
    public void setTexListener(CameraTextureListener mTexListener) {
    ...
    protected abstract void setCameraPreviewSize(
            int width,
            int height
    ); // updates mCameraWidth & mCameraHeight

    public CameraGLRenderer(GLSurfaceView view) {
        mView = view;
    ...
    protected synchronized void doStart() {
        ...
        if (mCameraWidth > 0 && mCameraHeight > 0)
            setPreviewSize(
                    mCameraWidth,
                    mCameraHeight
            ); // start preview and call listener.onCameraViewStarted()
    }
    ...
    protected void doStop() {
        ...
        if (mTexListener != null) mTexListener.onCameraViewStopped();
    ...
    protected void setPreviewSize(int width, int height) {
        ...
        if (mTexListener != null) mTexListener.onCameraViewStarted(mCameraWidth, mCameraHeight);
    }
