...
fun MainScreen(
    ...
    onScreenShootClick: (ServiceInfo) -> Unit
) {
            ...
            LazyColumn(
                ...
                items(serviceInfos) { info ->
                    ...
                    ServiceInfoItem(
                        ...
                        screenShoot = "截图",
                        screenShootClick = { onScreenShootClick(info) })
                }
            }
        }
    }
...
fun ServiceInfoItem(
    ...
    privateStorageClick: () -> Unit,
    externalStorage: String,
    externalStorageClick: () -> Unit,
    screenShoot: String,
    screenShootClick: () -> Unit,
) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Box(
                    ...
                    Text(
                        ...
                        color = Color.White,
                        fontSize = TextUnit(24.dp.adapt().value, TextUnitType.Sp),
                        modifier = Modifier.clickable(onClick = screenShootClick)
                    )
                }
